...
16. Congrats! You have successfully implement your proof of concept rootkit! What other functions would we be able to develop using a more flushed out rootkit?
 	<details closed>
	<summary>Answer</summary>
	<br>
	Communicate from the device to other connected devices! Set their speed, replace firmware, override instructions., and more!
	(To Bootloader)
